...
import { probeServer, detectProjectType, fetchRequestList, } from './debugbar/client.js';
import { startChromeMonitor, pingChrome, } from './chrome/browser.js';
        ...
        try {
            ...
            if (reachable) {
                ...
                if (config.chrome.autoConnect) {
                    ...
                    if (chromeReachable) {
                        try {
                            await startChromeMonitor(config.chrome.host, config.chrome.port, baseUrl, async (event) => {
                                try {
