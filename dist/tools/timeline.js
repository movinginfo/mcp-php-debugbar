...
export function registerTimelineTools(server) {
    server.tool('debugbar_get_timeline', 'Get the performance timeline for a PHP/Laravel request. Shows measured code blocks, their duration, and relative start times.', {
        id: z
            .string()
            .optional()
    ...
    server.tool('debugbar_performance_summary', 'Show a performance summary across all captured requests — total time, query count, memory. Useful for spotting slow pages.', {
        sort_by: z
